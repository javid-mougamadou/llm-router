...
# Build and run (dev with hot-reload)
...
- **Passwords** are hashed with PBKDF2-SHA256 (100k iterations, 16-byte random salt). Legacy SHA-256 hashes are auto-verified for backward compatibility.
